...
public class History {
    // Method to display donation history for a given user
    public static void showDonationHistory() {
        String query = "SELECT DonationId, UserId, date_time, DonationType, Status, Amount, NoOfItems, Item, ModeOfPayment, Delivery, OrganizationId FROM Donations;";
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            System.out.println("+==============================================================================================================================================================+");
            System.out.println("| User ID     | Donation ID | Organization ID | Date & Time            | Type        | Amount / Items   | MOP              | MOS               | Status        |");
            System.out.println("+-------------+-------------+-----------------+------------------------+-------------+------------------+------------------+-------------------+---------------+");
            ...
            while (rs.next()) {
                ...
                System.out.printf("| %-11d | %-11d | %-15d | %-22s | %-11s | %-16s | %-17s| %-18s| %-13s |\n",
