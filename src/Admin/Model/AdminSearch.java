...
public class AdminSearch {
    ...
    // Method to search for donations based on user input
    public static void searchDonations() {
        try {
            ...
            if (userId != null) query.append(" AND UserId = ?");
            ...
            try (Connection conn = DatabaseConnection.getConnection();
                ...
                try (ResultSet rs = pstmt.executeQuery()) {
                    ...
                    while (rs.next()) {
                        ...
                        System.out.printf("| %-10s | %-11d | %-11d |  %-10d | %-23s | %-10s | %-16s | %-16s | %-16s | %-16s |\n",
